...
class HomeDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          HomeDetailsCubit(HomeDetailsUseCase(locator<HomeDetailsRepoImp>()))
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              ...
                                              style:
                                                  AppTextStyle.textK12ForQuality),
                                        ],
                                      ),
                                    ),
                                    const Spacer(),
                                                  ...
                                                  decoration: BoxDecoration(
                                                      borderRadius:
                                                          BorderRadius.circular(
                                                              12.r)),
                                                  child: Image.network(
                                                    'https://image.tmdb.org/t/p/w500${state.movieModel.backdropPath}',
                                                    width: 53.w,
                                                    fit: BoxFit.cover,
                                                  )),
